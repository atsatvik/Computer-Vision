...
Main Function - takes dataset location as arguments and gives options between saving CSV file or comparing a query 
image with the dataset. If CSV file is not saved before it needs to be saved before comparison is done.
...
//                        char baseline_csv[256] = "baseline.csv";
...
//                    //hist_matching 
//                    if (save_type == "hist") {
//                        char hist_matching_csv[256] = "hist.csv";
...
//
//                        char multi_hist_matching_csv[256] = "multi_hist.csv";
...
//                        char texcolor_csv[256] = "tex_color.csv";
//
//                        cv::Mat xsobel_img;
...
//
//                char hist_csv[256] = "multi_hist.csv";
//                std::vector<char*> filenames;
//                std::vector<std::vector<float>> data;
//                int echo_file = 0;
//                read_image_data_csv(hist_csv, filenames, data, echo_file);
...
//
//                char hist_csv[256] = "tex_color.csv";
//                std::vector<char*> filenames;
//                std::vector<std::vector<float>> data;
//                int echo_file = 0;
//                read_image_data_csv(hist_csv, filenames, data, echo_file);
