...
Main Function - Takes the frame from the video output
                Based on what user choses, this program either extract chessboard corners, calibrate camera, augment
                objects or detect harris features of a pattern.
*/
